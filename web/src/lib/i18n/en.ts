export const en = {
    ...
    "logs.subtitle":
      "Raw per-call log of every /v1/chat/completions and /v1/messages request that hit the gateway.",
    "logs.refresh": "Refresh",
    "logs.searchPlaceholder": "Search request, response, or error…",
    "logs.filterKey": "Virtual key id",
    "logs.filterModel": "Model",
    "logs.filterStatus": "Status",
    "logs.filterStatusAll": "All",
    "logs.filterStatus2xx": "2xx success",
    "logs.filterStatus4xx": "4xx client error",
    "logs.filterStatus5xx": "5xx server error",
    "logs.filterStream": "Stream",
    "logs.filterStreamAll": "Any",
    "logs.filterStreamOn": "Streaming",
    "logs.filterStreamOff": "Non-stream",
    "logs.clear": "Clear",
    "logs.colTime": "Time",
    "logs.colKey": "Key",
    "logs.colModel": "Model",
    ...
    "logs.colTokens": "Tokens (p / c / t)",
    "logs.colLatency": "Latency",
    "logs.colTTFT": "TTFT",
    "logs.colCost": "Cost",
    "logs.streamBadge": "stream",
    "logs.empty": "No request logs yet.",
    "logs.emptySearch": "No logs match the current filter.",
    "logs.previousPage": "Previous",
    "logs.nextPage": "Next",
    "logs.pageOf": "{from}–{to} of {total}",
    "logs.detailTitle": "Request log",
    "logs.detailMetadata": "Metadata",
    "logs.detailRequest": "Request body",
    "logs.detailResponse": "Response body",
    "logs.detailError": "Error",
    "logs.detailEndpoint": "Endpoint",
    "logs.detailMethod": "Method",
    "logs.detailModelRequested": "Model requested",
    "logs.detailModelResolved": "Model resolved",
    "logs.detailProvider": "Provider",
    "logs.detailIsStream": "Stream",
    "logs.detailClientIP": "Client IP",
    "logs.detailUserAgent": "User agent",
    "logs.detailStartedAt": "Started",
    "logs.detailCompletedAt": "Completed",
    "logs.detailFirstByteAt": "First byte",
    "logs.detailLatencyMs": "Latency",
    "logs.detailTTFTMs": "TTFT",
    "logs.detailTokens": "Tokens",
    "logs.detailCost": "Cost (USD)",
