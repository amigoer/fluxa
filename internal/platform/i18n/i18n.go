...
const (
	...
	KeyNotifySendFailed        Key = "notify.send_failed"
	KeyNotifyChannelIncomplete Key = "notify.channel_incomplete"
	KeyPermissionDenied        Key = "rbac.permission_denied"
	KeyQuotaExceeded           Key = "quota.exceeded"
	KeyCostCeilingExceeded     Key = "quota.cost_ceiling_exceeded"
	...
	KeyProviderKindUnsupported Key = "provider.kind_unsupported"
	...
	KeyTooManyRequests         Key = "common.too_many_requests"
)
